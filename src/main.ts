...
import {changeDataForm} from "../src/blocks/change-data-form/change-data-form-build.ts";
import {changePasswordForm} from "../src/blocks/change-password-form/change-password-form-build.ts";
